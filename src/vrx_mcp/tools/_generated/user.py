"""Vicarius vRx MCP tools for domain: user.
...
def register(mcp: FastMCP, *, read_only: bool) -> None:
    ...
    async def user_search(
        ...
        return await execute_request("POST", "/user/search", path_params={}, query={"q": q, "sort": sort, "group": group, "from": from_, "size": size, "includeFields": includeFields}, body=body)
