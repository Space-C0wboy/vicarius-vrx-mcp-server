"""Vicarius vRx MCP tools for domain: patch_package_links.
...
def register(mcp: FastMCP, *, read_only: bool) -> None:
    ...
    async def patch_package_links_search_by_fields(
        ...
        return await execute_request("POST", "/patchPackageLinks/searchByFields", path_params={}, query={"from": from_, "size": size, "enabled": enabled, "addCount": addCount, "q": q, "sort": sort, "groupBy": groupBy, "includeFields": includeFields}, body=body)
