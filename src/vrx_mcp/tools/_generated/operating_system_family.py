"""Vicarius vRx MCP tools for domain: operating_system_family.
...
def register(mcp: FastMCP, *, read_only: bool) -> None:
    ...
    async def operating_system_family_search_by_fields(
        ...
        return await execute_request("POST", "/operatingSystemFamily/searchByFields", path_params={}, query={"from": from_, "size": size, "enabled": enabled, "addCount": addCount, "q": q, "sort": sort, "groupBy": groupBy, "includeFields": includeFields}, body=body)
